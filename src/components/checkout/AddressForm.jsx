  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
      ...
      <div className="bg-[#FDFBF7] rounded-[2.5rem] p-4 shadow-2xl shadow-[#8B5E3C]/5 border border-[#E8E1D5] relative overflow-hidden group">
        <div className="absolute top-6 left-1/2 -translate-x-1/2 z-[1000] bg-[#FDFBF7]/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/50 pointer-events-none transition-all">
          <h2 className="text-[#1A4D2E] font-bold flex items-center gap-1.5 text-xs uppercase tracking-widest"><MapPin className="w-4 h-4 text-[#8B5E3C]" /> Pin Location</h2>
        </div>
      ...
      <div className="lg:pl-4 space-y-6 sm:space-y-8 flex flex-col justify-center lg:min-h-[650px]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex flex-col sm:mb-8">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A4D2E] mb-2 sm:mb-3" style={{ fontFamily: "var(--font-playfair)" }}>Delivery Address</h1>
            <p className="text-[#8B5E3C] text-base sm:text-lg" style={{ fontFamily: "var(--font-outfit)" }}>Enter your details to finalize delivery.</p>
          </div>
        ...
        <div className="bg-[#FDFBF7] p-5 sm:p-8 lg:p-10 rounded-3xl sm:rounded-[2.5rem] border border-[#E8E1D5] shadow-sm">
          ...
          <div className="mt-8 sm:mt-10">
            <button
              ...
              className={`w-full flex items-center justify-between px-5 sm:px-8 py-4 sm:py-5 text-white rounded-2xl font-bold text-base sm:text-lg transition-all duration-300 group ${!storeStatus?.isOpen ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#8B5E3C] hover:bg-[#734A2E] shadow-[0_10px_30px_rgba(139,94,60,0.25)] hover:-translate-y-1 hover:shadow-[0_15px_35px_rgba(139,94,60,0.35)]'}`}
            >
